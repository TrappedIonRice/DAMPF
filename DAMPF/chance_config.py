'''
This is the adventurous configuration file with a large amount of sites and modes for the DAMPF simulation.
...
noscpersite = 5            # number of oscillators per site
...
freqs_per_site = [1, 1.2, 1.4, 1.6, 1.8]   # frequencies of oscillators
temp_K = 0
coupling_strength = [[1, 1.2, 1.4, 1.6, 1.8],
                     [1, 1.2, 1.4, 1.6, 1.8],
                     [1, 1.2, 1.4, 1.6, 1.8],
                     [1, 1.2, 1.4, 1.6, 1.8],
                     [1, 1.2, 1.4, 1.6, 1.8]]
damping_rate_per_osc = [0.05,0.05,0.05,0.05,0.05]
